package de.floskater99.mapmenu.fontfix;
 ...
 */
public class MapFontCopy {

    public final HashMap<Character, CharacterSprite> chars = new HashMap<>();
    ...
    public int getWidth(String text) {
        ...
        for (int i = 0; i < text.length(); ++i) {
            ...
            if (ch == ChatColor.COLOR_CHAR) {
                ...
                if (j < 0) throw new IllegalArgumentException("Label contains unterminated color string");
                ignored += j-i+1;
                i = j;
                continue;
            }
